...
export default function NotFound() {
    return (
        <>
            <div className="bg-gray-100 h-screen justify-center py-16">
                <center className="">
                    <svg 
                        className="emoji-404"
                    ...
                    >
                        ...
                        <ellipse cx="154.88" cy="140.894" enableBackground="new" fill="#FF0000" opacity="0.18" rx="17.371" ry="8.106" /><path d="M13,118.5C13,61.338,59.338,15,116.5,15c55.922,0,101.477,44.353,103.427,99.797  c0.044-1.261,0.073-2.525,0.073-3.797C220,50.802,171.199,2,111,2S2,50.802,2,111c0,50.111,33.818,92.318,79.876,105.06  C41.743,201.814,13,163.518,13,118.5z" fill="#FFEFB5" />
                ...
                <center className="md:my-16 my-8">
                    <Link href="/" role='button' className="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go back</Link>
                </center>
            </div>
        </>
